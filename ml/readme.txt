...
1. 개요
 ...
 - 통계학, 컴퓨터 과학, 데이터마이닝, 인공지능 등 전문분야가 섞여있다.
...
2. 정의
 ...
 - 톰미첼 : 어떤 작업 (Task:T)에 대한 컴퓨터 프로그램의 성능 P(Perpernce)로 측정을 하였을때,
    경험 Experience(E)로 인해 성능이 향상되었다면, 이 컴퓨터 프로그램은 작업 T와 성능측정 P에
    대해 경험 E로 학습한 것이다. (최초는 허술하나 학습이 증가될수록 우수한 성능을 발휘)
...
4. 머신러닝 시스템 종류
  ...
  - 준지도 학습 : semisupervised learning
    ...
    => 심층신뢰신경망,... <= 비지도 + 지도 학습의 조합으로 구성
  - 강화 학습 : reinforcement learning
    - 에이전트 : 학습하는 시스템
    - 환경을 관찰, 행동을 실행, 이에 따른 결과를 보상(긍정적보상:reward, 부정적보상:penalty)
...
7. 라이브러리
 ...
 - scipy : 싸이파이 (함수 알고리즘, 수학식 등등 구현)
   ...
   - 특수 수학
   - 통계 분포
   - 회소 행렬 등등 => 함수로 알고리즘을 구현해 놓았다.
 - scikit-learn : 싸이킷런
   - numpy + scipy 의조합 
 ------------------------------------------------
 딥러닝 엔진 -> GPU 사용가능 => 학습 속도 향상 => 결과를 빠르게 보고 => 여러 방향 접근 가능
